        ...
        for idse in self:
            if idse.report_type == "alta":
                ...
                return {
                    ...
                    "url": "/web/content/hr.payroll.idse.reports/{}/txt_file"
                    "/{}?download=true".format(self.id, "alta.txt"),
                    "target": "self",
                }
                ...
                return {
                    "type": "ir.actions.act_url",
                    "url": "/web/content/hr.payroll.idse.reports/{}"
                    "/txt_file/{}?download=true".format(self.id, "baja.txt"),
                    "target": "self",
                }
            ...
            if idse.report_type == "mod_wage":
                ...
                return {
                    "type": "ir.actions.act_url",
                    "url": "/web/content/hr.payroll.idse.reports/{}"
                    "/txt_file/{}?download=true".format(self.id, "mod_sal.txt"),
                    "target": "self",
                }
